...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public MainAdapter(List<IndexCommondEntity> pBottomList, List<String> pBannerData, List<BannerLiveInfo.Live> pLiveData, Activity pContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (getItemViewType(position) == BANNER) {
           ...
           MainLiveAdapter adapter = new MainLiveAdapter(mContext,liveData);
            ...
            if (getItemViewType(position) == BIG_IMAGE) {
                ...
                holder.studyNum.setText(entity.getView_num()+"人学习");
                holder.goodPercent.setText(entity.sumhot+"%好评率");
            } else {
